...
from py12box_ocean import startup, core, get_data
...
class Model:
    ...
    def __init__(self, species, project_directory,
        ...
        # Get piston velocity and ocean degradation half-life
        piston_velocity, half_life = startup.get_ocean_parameters(species)
    ...
    def tune_lifetime(self,
        ...
        if self.steady_state_lifetime > threshold:
            ...
            print(f"... overall lifetime: {self.steady_state_lifetime:.2f}")
